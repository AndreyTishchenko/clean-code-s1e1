...
var createNewTaskElement=function(taskString){
    ...
    label.className='task-input-edit';
    ...
    editButton.className="save-changing";
...
var editTask=function(){
    ...
    var editBtn=listItem.querySelector(".save-changing");
...
//select ListItems children
    ...
    var editButton=taskListItem.querySelector("button.save-changing");
